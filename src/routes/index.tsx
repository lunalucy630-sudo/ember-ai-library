...
import { Sparkles, Video, BookOpen, MessagesSquare, Flame } from "lucide-react";
    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <header className="relative z-10 mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
        ...
        <div className="flex items-center gap-2">
          <LangThemeSwitcher />
          <Link to="/auth">
            <Button variant="ghost" className="rounded-full">{t("landing.signIn")}</Button>
          </Link>
      ...
      <main className="relative z-10 mx-auto max-w-6xl px-6 pt-20 pb-32 text-center">
        ...
        <div className="mt-20 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[
            { icon: Video, title: t("landing.features.video.title"), body: t("landing.features.video.body") },
            { icon: Sparkles, title: t("landing.features.ai.title"), body: t("landing.features.ai.body") },
            { icon: BookOpen, title: t("landing.features.library.title"), body: t("landing.features.library.body") },
            { icon: MessagesSquare, title: t("landing.features.chat.title"), body: t("landing.features.chat.body") },
          ].map((f, i) => (
            <div
              key={f.title}
